...
public class CodeGenerator {
    ...
    // datasource
    private final static String URL = "jdbc:mysql://localhost:3306/title_evaluation?serverTimezone=GMT%2B8&allowMultiQueries=true&characterEncoding=UTF-8";
    private final static String DRIVER = "com.mysql.cj.jdbc.Driver";
    private final static String USERNAME = "root";
    private final static String PASSWORD = "123456";


    private final static String PARENT = "com.evildoer.evaluation";
...
//    private final static String TABLE_NAMES = "base,branch_office,code,evaluation,jury,person,unit,user";
    /**
     ...
     WHERE TABLE_SCHEMA='title_evaluation'
     **/
...
//        strategy.setSuperControllerClass("com.baomidou.ant.common.BaseController");
        ...
        strategy.setSuperEntityClass("com.evildoer.evaluation.common.domain.BaseEntity");
